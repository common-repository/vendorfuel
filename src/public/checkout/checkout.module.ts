...
import { CheckoutShippingMethod } from './shipping-method/checkout-shipping-method.component';
...
export const CheckoutModule = angular
	...
	.component('checkoutShippingAddress', CheckoutShippingAddress)
	.component('checkoutShippingMethod', CheckoutShippingMethod).name;
