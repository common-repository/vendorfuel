...
angular.module('vfApp').component('checkoutShippingMethod', {
	template,
	require: {
...
ShippingMethodController.$inject = ['Alerts', 'Checkout'];

function ShippingMethodController(Alerts, Checkout: CheckoutService) {
	const vm = this;
	vm.isLoading = false;
