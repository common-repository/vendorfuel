...
import { CheckoutService } from '../../../../src/js/public/services/checkout.service';
...
class ExtraField {
	...
	constructor(label, isRequired = false, value = '', autocomplete = 'off') {
		this.label = label;
		this.value = value;
...
angular.module('vfApp').component('vfCheckout', {
	bindings: {
		poPrefix: '@',
	},
	template,
